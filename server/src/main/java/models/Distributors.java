...
public class Distributors {
    ...
    /**
     * Creates the initial list of distributors from Distributors.xlsx utilizing
     * Apache POI
     *
    ...
    private List<Distributor> createDistributors() {
        ...
        try {
            ...
            // ! Would log this with appropriate logging tool, but printing error for now
            // and guard with return
            e.printStackTrace();
            return null;
        }
                ...
                if (row != null) {
                    ...
                    for (int cellNum = 0; cellNum < row.getPhysicalNumberOfCells(); cellNum++) {
                        ...
                        if (cell != null) {
                            ...
                            // ! Spreadsheet is empty in cell. Should be impossible in given scenario. Log
    ...
    /**
     * Given a list of items to restock and their stock amounts, calculates lowest
     * restock cost among distributors
     *
